...
// }
// console.log(count);
// Always choose const and give the browser to choose !!?
//*************Will Work*******************
// let count = 0;
// for (let i = 0; i < 10; i++) {
//   count = count + i;
...
// }
// console.log(str);
// choose a meaning names to your arrays depending of the data type
//*************Better*******************
// const names = ["James", "Jess", "Lily", "Semi"];
// let retVal = "";
...
// Always use === unless you have a very very good re   son to use == , and i wonder what it will be!!!
//********************************
...
// const names = ["Jess", "James",  "Semi", "Lily"];
...
//********************************
//pour le future proche inchaa Allah
